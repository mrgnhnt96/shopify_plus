...
class CustomerErrorCodeJson extends JsonConverter<CustomerErrorCode, String> {
  ...
  static const _passwordStartsOrEndsWithWhitespaceName =
...
/// {@macro json_converter}
class CustomerErrorCodeJsonNullable
    extends JsonConverter<CustomerErrorCode?, String?> {
  /// {@macro json_converter}
  const CustomerErrorCodeJsonNullable();

  @override
  CustomerErrorCode? fromJson(String? json) {
    if (json == null) return null;
    const jsonConverter = CustomerErrorCodeJson();
...
extension CustomerErrorCodeX on CustomerErrorCode {
  ...
  String get name {
    return map(
      ...
      invalidMultipassRequest:
          CustomerErrorCodeJson._invalidMultipassRequestName,
      notFound: CustomerErrorCodeJson._notFoundName,
      passwordStartsOrEndsWithWhitespace:
          CustomerErrorCodeJson._passwordStartsOrEndsWithWhitespaceName,

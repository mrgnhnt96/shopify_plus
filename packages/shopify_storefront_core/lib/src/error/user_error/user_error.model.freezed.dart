...
class _$UserErrorTearOff {
  ...
  _UserError call({List<String>? field, required String message}) {
    return _UserError(
      field: field,
      message: message,
    );
...
abstract class $UserErrorCopyWith<$Res> {
  ...
  $Res call({List<String>? field, String message});
}
...
class _$_UserError extends _UserError {
  const _$_UserError({this.field, required this.message}) : super._();
...
abstract class _UserError extends UserError {
  const factory _UserError({List<String>? field, required String message}) =
      _$_UserError;

...
part of 'selected_option.model.dart';
...
class _$_SelectedOption extends _SelectedOption {
  const _$_SelectedOption({required this.name, required this.value})
      : super._();
...
abstract class _SelectedOption extends SelectedOption {
  const factory _SelectedOption({required String name, required String value}) =
      _$_SelectedOption;
  const _SelectedOption._() : super._();
